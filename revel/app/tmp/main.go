...
import (
	...
	_ "code.google.com/p/goconvert/revel/app"
	controllers "code.google.com/p/goconvert/revel/app/controllers"
	tests "code.google.com/p/goconvert/revel/tests"
	...
	revel.RegisterController((*controllers.WebSocket)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "ConvertSocket",
				Args: []*revel.MethodArg{ 
					&revel.MethodArg{Name: "c", Type: reflect.TypeOf((**websocket.Conn)(nil)) },
				},
				RenderArgNames: map[int][]string{ 
				},
			},
